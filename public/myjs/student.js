 		...
 		success: function (data) {
          ...
          list = data.list;
             ...
             var s = '<table class="table">';
             	s += '<thead><tr><th>序号</th><th>名字</th><th>学号</th><th>个人信息</th><th>学习成绩</th></tr></thead><tbody>';
              ...
              $.each(list,function(index,array){ //遍历json数据列 
            	  ...
            	  s += '<tr><td>'+(++index)+'</td><td>'+name+'</td><td>'+number+'</td><td><a href="">基本信息</a></td><td><a href="">学习成绩</a></td></tr>';
	                              ...
	                              list1 = data1.list;   
	                                 if (list1 != null) {                            
	                                	 var s = '<table class="table">';
	                                 	 ...
	                                 	 s += '<tr><td>'+(++index+(page-1)*rows)+'</td><td>'+name+'</td><td>'+number+'</td><td><a href="">基本信息</a></td><td><a href="">学习成绩</a></td></tr>';
